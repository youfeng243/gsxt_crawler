...
if __name__ == '__main__':
    print get_md5("国网西藏招标有限公司")
    print json.dumps(url_query_decode("searchKey=&bidMenu=&bidMenuName=&chnlIds=&bidType=0&bidWay=0&region=339900&releaseStartDate=&releaseEndDate=&noticeEndDate=&noticeEndDate1=&pub_org=&solrType=0&frontMobanType=1&pageNum=4&pageCount=1000"))
    print url_encode("http://xy.fspc.gov.cn/tentbaseinfoAction!getTentbaseinfoById.do?creditquery.id=2C47AD61C2CE405FADA921CA7E6EAB13&num=4")
    ...
    hzurl='http://wenshu.court.gov.cn/List/ListContent?HZPOST=eyJEaXJlY3Rpb24iOiAiZGVzYyIsICJJbmRleCI6IDUwLCAiT3JkZXIiOiAiXHU4OGMxXHU1MjI0%0AXHU2NWU1XHU2NzFmIiwgIlBhZ2UiOiAiMjAiLCAiUGFyYW0iOiAiXHU0ZTBhXHU0ZjIwXHU2NWU1%0AXHU2NzFmOjIwMTYtMTItMjkgVE8gMjAxNi0xMi0zMCxcdTZjZDVcdTk2NjJcdTU3MzBcdTU3ZGY6%0AXHU4ZmJkXHU1YjgxXHU3NzAxLFx1NGUyZFx1N2VhN1x1NmNkNVx1OTY2MjpcdThmYmRcdTViODFc%0AdTc3MDFcdThmYmRcdTZjYjNcdTRlMmRcdTdlYTdcdTRlYmFcdTZjMTFcdTZjZDVcdTk2NjIifQ%3D%3D%0A'
    print hzurl
    print json.dumps(extract_hzpost_url(hzurl), ensure_ascii=False)
