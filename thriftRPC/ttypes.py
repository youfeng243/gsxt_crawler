...
class SessionCommit:
    ...
    def __init__(self, refer_url=None, identifying_code_url=None, identifying_code_check_url=None, session_msg=None,
                 check_body=None, check_body_not=None, need_identifying=thrift_spec[7][4], ):
...
class DownLoadReq:
    ...
    def __init__(self, url=None, method=thrift_spec[2][4], download_type=thrift_spec[3][4], ip_list=None, src_type=None,
                 priority=None, retry_times=None, time_out=None, post_data=None, http_header=None, session_commit=None,
                 verify=thrift_spec[12][4], max_content_length=None, user=None, password=None, scheduler=None,
                 parse_extends=None, data_extends=None, proxy=None, info=thrift_spec[20][4],
                 use_proxy=thrift_spec[21][4], ):
        self.url = url
        self.method = method
...
class DownLoadRsp:
    ...
    def __init__(self, url=None, redirect_url=None, src_type=None, status=None, http_code=None, download_time=None,
                 elapsed=None, pages=None, content_type=None, content=None, page_size=None, scheduler=None,
                 parse_extends=None, data_extends=None, info=thrift_spec[15][4], ):
        self.url = url
